            ...
            <div  className="web-code-editor web-overlay">
                <div className="web-code-editor-header">
                    <div className="web-code-languages-div">
                        <p className={`web-editor-tab ${currentCodeEditor===HTML ? "selected-web-tab" : ""}`} onClick={() => setCurrentCodeEditor(HTML)}><DiHtml5 fontSize={20} /> <span>HTML</span></p>
                        <p className={`web-editor-tab ${currentCodeEditor===CSS ? "selected-web-tab" : ""}`} onClick={() => setCurrentCodeEditor(CSS)}><DiCss3 fontSize={20} /> <span>CSS</span></p>
                        <p className={`web-editor-tab ${currentCodeEditor===JAVASCRIPT ? "selected-web-tab" : ""}`} onClick={() => setCurrentCodeEditor(JAVASCRIPT)}><DiJavascript1 fontSize={20} /> <span>JAVASCRIPT</span></p>
